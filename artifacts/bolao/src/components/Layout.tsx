...
export function Layout({ children }: LayoutProps) {
  ...
  const userNameClass = cn(
    "text-sm font-semibold truncate transition-all duration-1000",
    userPosition === 1
      ? "top1-name"
      : userPosition === 2
        ? "top2-name"
    ...
    <div className="min-h-screen bg-background flex">
      <style>
        {`
          ...
          .top1-name {
            background: linear-gradient(90deg, #b45309, #f59e0b, #fde68a, #ffffff, #fde68a, #f59e0b, #b45309);
          ...
          .top2-name {
            background: linear-gradient(90deg, #64748b, #cbd5e1, #ffffff, #e2e8f0, #94a3b8, #64748b);
            background-size: 300% auto;
            -webkit-background-clip: text;
            background-clip: text;
            color: transparent;
          ...
          .top3-name {
            background: linear-gradient(90deg, #78350f, #b45309, #d97706, #fbbf24, #d97706, #92400e);
            background-size: 300% auto;
            -webkit-background-clip: text;
            background-clip: text;
            color: transparent;
      ...
      <main className="flex-1 md:ml-64 min-h-screen">
        <div className="mt-14 md:mt-0 pb-20 md:pb-0">{children}</div>
      </main>
    </div>
  );
}
